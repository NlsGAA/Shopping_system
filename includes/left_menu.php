    ...
    <div class="cart_element">
        ...
        <div class="content_cart_body">
            <?php if ($cart_itens !== 0 && is_array($cart_itens)) : ?>
                ...
                <button name="deleteAllItens" id="deleteCart" type="button" data-bs-toggle="modal" data-bs-target="#cartDeleteItens">
                ...
                ?>
                        ...
                        <!-- Modal Delete Cart Itens -->
                        <div class="modal fade" id="cartDeleteItens" tabindex="-1" aria-labelledby="itemModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="itemModalLabel">Esvaziar carrinho?</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                                        <form action="http://localhost/sistema_de_compra/php_action/cartDeleteAllItens.php" method="POST">
                                            <button type="submit" class="btn btn-danger" name="deleteAllItens">Esvaziar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
